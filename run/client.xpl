<p:declare-step 
	...
	<p:import href="../src/xproc/libri-augmentati.xpl" />
...
<!--	<p:option name="debug-path" as="xs:string" select="'../_debug/client'" />-->
	...
	<p:option name="output-directory" as="xs:string" select="'../_results/'" />
	...
	<p:identity message="Processing document with following parameters: 	
		...
		<lax:build-virtual-document p:use-when="true()"
			...
			base-uri="{$base-uri}">
			<p:with-input port="settings" href="../src/settings/libraries.xml" />
